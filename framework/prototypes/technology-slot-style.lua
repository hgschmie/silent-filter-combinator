...
local FrameworkPrototypesTechnologySlotStyle = {}

--- @param mod_root string The mod root.
function FrameworkPrototypesTechnologySlotStyle.init(mod_root)
  ...
  local function build_technology_slot(name, y, level_color, level_range_color)
    styles["flib_technology_slot_" .. name] = {
      ...
      default_graphical_set = {
        base = {
          filename = mod_root .. "/framework/graphics/technology-slots.png",
          position = { 0, y },
          size = { 144, 200 },
        },
...
return FrameworkPrototypesTechnologySlotStyle
