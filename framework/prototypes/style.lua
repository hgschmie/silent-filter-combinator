...
function FrameworkPrototypesStyle.init(mod_root)
  local data_util = require("framework.prototypes.data-util"):init(mod_root)
  
  local styles = data.raw["gui-style"].default

  local slot_tileset = mod_root .. "/framework/graphics/slots.png"
  ...
  styles.framework_subheader_horizontal_line = {
    ...
    border = {
      border_width = 8,
      horizontal_line = { filename = mod_root .. "/framework/graphics/subheader-line.png", size = { 1, 8 } },
    },
  }
...
return FrameworkPrototypesStyle
